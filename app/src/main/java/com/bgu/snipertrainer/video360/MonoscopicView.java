...
public class MonoscopicView extends GLSurfaceView {
    ...
    {
        void onRotation(float[] angles, int accuracy);
    }
    ...
    public void initialize() {
        ...
        // Initialize Angles floats for ui
        azimuth_deg = 0;
        pitch_deg = 0;
        roll_deg = 0;
    }
    ...
    private class PhoneOrientationListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            // Angles to ui listener
            listener.onRotation(angles, event.accuracy);
        }
    ...
    static class Renderer implements GLSurfaceView.Renderer {
        ...
        private static final int FIELD_OF_VIEW_DEGREES = 9;  // Yariv: 9 for my 100 cm convex lens (74 cm focus length). was 13.
